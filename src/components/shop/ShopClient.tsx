  ...
  return (
    <div>
      <header className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <h1 className="font-display text-4xl font-semibold md:text-5xl">All Jerseys</h1>
          <p className="mt-2 text-secondary">
            <span className="tnum">{results.length}</span> item{results.length === 1 ? "" : "s"}
          </p>
        </div>
        ...
        <div>
          {visible.length === 0 ? (
            <div className="flex flex-col items-center gap-4 py-20 text-center">
              ...
              <p className="text-lg font-medium">No jerseys found</p>
